...
- [ ] Phase 10: 맞춤제작 관리 및 통합 대상자 관리 (0/47) - 0% - [개발 계획 문서](./docs/phase10-development-plan.md)
...
- [ ] ⏳ 대상자 목록에 활동 요약 표시 | 개발자1 | 4h | 10.2.1
  - [ ] 목록 테이블에 활동 통계 컬럼 추가
    - 상담 수
    - 평가 수
    - 진행 중인 대여 수
...
- [ ] ⏳ 대상자 목록 통합 필터 | 개발자1 | 3h | 10.2.1
  - [ ] 활동 유형별 필터 (상담 있음, 평가 있음, 대여 있음 등)
  - [ ] 활동 횟수 범위 필터
  - [ ] 최근 활동 날짜 필터

**진행률**: 13/16 (81%) - 통합 활동 탭, 통계 API, 대시보드 위젯, 통합 검색 완료, 대상자 목록 개선 대기 중
...
- [ ] ⏳ 평가 일정 생성 API 구현 | 개발자2 | 4h | 10.3.1
  - [ ] POST /api/schedules/assessment 엔드포인트 구현
  - [ ] 평가 유형 연동 (기능 평가, 환경 평가, 욕구 평가)
  - [ ] 평가 장소 필드 추가
  - [ ] 감사 로그 구현 (`assessment_schedule_created`)
- [ ] ⏳ 평가 일정 조회 API 구현 | 개발자2 | 2h | 10.3.1
  - [ ] 평가 일정 전용 필터링 옵션 추가
  - [ ] 평가 유형별 조회 지원

#### 10.3.4 대여/맞춤제작 일정 관리 기능

- [ ] ⏳ 대여 일정 생성 API 구현 | 개발자2 | 4h | 10.3.1
  - [ ] POST /api/schedules/rental 엔드포인트 구현
  - [ ] 대여 예약 기능 연동
  - [ ] 기기 준비 일정 자동 생성
  - [ ] 감사 로그 구현 (`rental_schedule_created`)
- [ ] ⏳ 맞춤제작 일정 생성 API 구현 | 개발자2 | 4h | 10.3.1, 10.1.3
  - [ ] POST /api/schedules/customization 엔드포인트 구현
  - [ ] 맞춤제작 단계별 일정 자동 생성
  - [ ] 제작 단계와 일정 연동
  - [ ] 감사 로그 구현 (`customization_schedule_created`)
...
- [x] ✅ 일정 생성 폼 UI | 개발자1 | 5h | 10.3.2, 10.3.3, 10.3.4
  ...
  - [x] 리마인더 설정 옵션
  - [x] 성공/실패 토스트 알림
- [ ] ⏳ 월별 캘린더 뷰 컴포넌트 | 개발자1 | 6h | 10.3.5
  - [ ] 월별 캘린더 뷰 컴포넌트
  - [ ] 일정 클릭 시 상세 정보 모달
  - [ ] 일정 유형별 색상 표시
  - [ ] 접근성 준수 (ARIA 라벨, 키보드 네비게이션)
- [ ] ⏳ 일정 알림 기능 | 개발자2 | 6h | 10.3.5
  - [ ] 일정 리마인더 알림 로직 구현
  - [ ] 브라우저 알림 (Web Notification API)
  - [ ] 알림 설정 관리 UI

**진행률**: 14/16 (88%) - 기본 일정 관리 UI 완료, 캘린더 뷰 및 알림 기능 대기 중

---

**Phase 10 전체 진행률**: 44/47 (94%) - 기본 기능 완료, 대상자 목록 개선 및 캘린더 뷰 대기 중
