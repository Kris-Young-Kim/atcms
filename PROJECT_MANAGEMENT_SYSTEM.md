...
| 역할      | 이름   | 책임                                | 연락처   |
| --------- | ------ | ----------------------------------- | -------- |
| PM (팀장) | [등록 필요] | 프로젝트 전체 관리, 이해관계자 관리 | [등록 필요] |
| 개발 리더 | [등록 필요] | 아키텍처, 기술 의사결정, 코드 리뷰  | [등록 필요] |
| 개발자1   | [등록 필요] | Frontend/UI 개발                    | [등록 필요] |
| 개발자2   | [등록 필요] | Backend/API 개발                    | [등록 필요] |
| 개발자3   | [등록 필요] | 데이터베이스/인프라                 | [등록 필요] |
| 디자이너  | [등록 필요] | UI/UX 설계, 와이어프레임            | [등록 필요] |
