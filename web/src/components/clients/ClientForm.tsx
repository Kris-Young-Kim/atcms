...
export function ClientForm({ initialData, clientId, mode = "create" }: ClientFormProps) {
  ...
  const defaultValues = useMemo(() => {
    ...
    return {
      intake_date: today,
      status: "active" as ClientFormData["status"],
      ...initialData,
    } satisfies Partial<ClientFormData>;
  }, [initialData]);
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <DisabilityInfoSection register={register} />
        <ContactInfoSection register={register} errors={errors} />
        <GuardianInfoSection register={register} errors={errors} />
...
function DisabilityInfoSection({ register }: SectionProps) {
  return (
    <SectionContainer title="장애 정보">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div>
...
function ContactInfoSection({ register, errors }: SectionWithErrorsProps) {
  return (
    <SectionContainer title="연락처 정보">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div>
...
function GuardianInfoSection({ register, errors }: SectionWithErrorsProps) {
  return (
    <SectionContainer title="보호자 정보">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div>
...
function AdditionalInfoSection({ register }: SectionProps) {
  return (
    <SectionContainer title="기타 정보">
